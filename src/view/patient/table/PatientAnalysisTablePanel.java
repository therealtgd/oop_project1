...
import view.model.PatientAnalysisModel;
...
public class PatientAnalysisTablePanel extends JPanel {
    ...
    public PatientAnalysisTablePanel(List<Analysis> data) {
        this.data = data;
        this.table = new JTable(new PatientAnalysisModel(data));
        initGUI();
        setVisible(true);
    }
    ...
    public void refresh() {
        PatientAnalysisModel m = (PatientAnalysisModel) this.table.getModel();
        ...
        this.data.sort(new Comparator<Analysis>() {
            ...
            public int compare(Analysis a1, Analysis a2) {
                switch (index) {
                    ...
                    case 2:
                        retVal = Double.compare(a1.getReferenceValue().getMin(), a2.getReferenceValue().getMin()) + Double.compare(a1.getReferenceValue().getMax(), a2.getReferenceValue().getMax());
                        break;
                    default:
